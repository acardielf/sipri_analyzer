 ...
 *     copy?: list<string|array{ // Default: [{"src":"%kernel.project_dir%/public","dest":".","fail_if_missing":true,"ignore_dot_files":true,"excludes":["*.php"]}]
 ...
 *     }>,
 *     providers?: array<string, string|array{ // Default: []
