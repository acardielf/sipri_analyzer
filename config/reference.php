 ...
 * }
 * @psalm-type StenopeConfig = array{
 *     build_dir?: scalar|Param|null, // The directory where to build the static version of the app // Default: "%kernel.project_dir%/build"
 *     shared_html_crawlers?: bool|Param, // Activate the sharing of HTML crawlers for better performances. // Default: false
 *     copy?: list<Param|string|array{ // Default: [{"src":"%kernel.project_dir%/public","dest":".","fail_if_missing":true,"ignore_dot_files":true,"excludes":["*.php"]}]
 *         src?: scalar|Param|null, // Full source path to the file/dir to copy
 *         dest?: scalar|Param|null, // Destination path relative to the configured build_dir. If null, defaults to the same name as source. // Default: null
 *         excludes?: list<scalar|Param|null>,
 *         fail_if_missing?: scalar|Param|null, // Make the build fail if the source file is missing // Default: true
 *         ignore_dot_files?: scalar|Param|null, // Whether to ignore or not dotfiles // Default: true
 *     }>,
 *     providers?: array<string, Param|string|array{ // Default: []
 *         type?: scalar|Param|null, // The provider type used to fetch contents // Default: "files"
 *         config?: array{
 *             path?: scalar|Param|null, // Required: The directory path for "files" providers
 ...
 *         route?: scalar|Param|null, // The name of the route to generate the URL
 *         slug?: scalar|Param|null, // The name of the route argument in which will be injected the content's slug
 *     }>,
 *     processors?: bool|array{ // Built-in processors configuration. Disable to unregister all of the preconfigured processors.
 *         enabled?: bool|Param, // Default: true
 *         content_property?: scalar|Param|null, // Key used by default by every processors to access and modify the main text of your contents // Default: "content"
 *         slug?: bool|array{
 *             enabled?: bool|Param, // Default: true
 *             property?: scalar|Param|null, // Inject the content slug in a property of your model. See SlugProcessor. // Default: "slug"
 *         },
 *         assets?: bool|array{ // Attempt to resolve local assets URLs using the Asset component for images and links. See AssetsProcessor.
 *             enabled?: bool|Param, // Default: true
 *         },
 *         resolve_content_links?: bool|array{ // Attempt to resolve relative links between contents using the route declared in config. See ResolveContentLinksProcessor.
 *             enabled?: bool|Param, // Default: true
 *         },
 *         external_links?: bool|array{ // Automatically add target="_blank" to external links. See HtmlExternalLinksProcessor.
 *             enabled?: bool|Param, // Default: true
 *         },
 *         anchors?: bool|array{ // Automatically add anchor links to elements with an id. See HtmlAnchorProcessor.
 *             enabled?: bool|Param, // Default: true
 *             selector?: scalar|Param|null, // Default: "h1, h2, h3, h4, h5"
 *         },
 *         html_title?: bool|array{ // Extract a content title from a HTML property by using the first available h1 tag. See ExtractTitleFromHtmlContentProcessor.
 *             enabled?: bool|Param, // Default: true
 *             property?: scalar|Param|null, // Property where to inject the title in your model // Default: "title"
 *         },
 *         html_elements_ids?: bool|array{ // Add ids to titles, images and other HTML elements in the content. See HtmlIdProcessor.
 *             enabled?: bool|Param, // Default: true
 *         },
 *         code_highlight?: bool|array{ // Enabled the syntax highlighting for code blocks using Prism.js. See CodeHighlightProcessor.
 *             enabled?: bool|Param, // Default: true
 *         },
 *         toc?: bool|array{ // Build a table of content from the HTML titles. See TableOfContentProcessor.
 *             enabled?: bool|Param, // Default: true
 *             property?: scalar|Param|null, // Property used to configure and inject the TableOfContent object in your model // Default: "tableOfContent"
 *             min_depth?: int|Param, // Default: 2
 *             max_depth?: int|Param, // Default: 6
 *         },
 *         last_modified?: bool|array{ // Attempt to fetch and populate the last modified date to a property. See LastModifiedProcessor.
 *             enabled?: bool|Param, // Default: true
 *             property?: scalar|Param|null, // Property where to inject the last modified date of the content according to its provider. // Default: "lastModified"
 *             git?: bool|array{ // Whether to attempt using Git to get the last modified date of the content according to commits.
 *                 enabled?: bool|Param, // Default: true
 *                 path?: scalar|Param|null, // Git binary path to use // Default: "git"
 *             },
 *         },
 *     },
 * }
