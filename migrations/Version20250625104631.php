 ...
 */
final class Version20250625104631 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Almacena fecha convocatoria';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TEMPORARY TABLE __temp__convocatoria AS SELECT id, curso_id, nombre FROM convocatoria
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO convocatoria (id, curso_id, nombre) SELECT id, curso_id, nombre FROM __temp__convocatoria
        SQL);
        $this->addSql(<<<'SQL'
