 ...
 */
final class Version20250625215744 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Ajudicaciones de plazas';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE adjudicacion (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, plaza_id INTEGER DEFAULT NULL, puesto INTEGER NOT NULL, CONSTRAINT FK_1299069AEF34C0BD FOREIGN KEY (plaza_id) REFERENCES plaza (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
